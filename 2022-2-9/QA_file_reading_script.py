...
with open("firstweber_2022_01_03.json", 'r') as myfile:
        ...
        for line_number, line in enumerate(lines):
            ...
            if not error:
                ...
                if "None" in d.values():
                    ...
                    error_log.append(
                        {'error': 'null', 'line_number': line_number+1, 'key': key})
                    print("key=", key)
                    print("line no=", line_number+1)
                    ...
                    res = [str(i or '') for i in file_data]
                    print("The list after conversion of null values : " + str(res))
    ...
    # if url in file_data:
    #         re.findall(r'https?://[^\s<>"]+|www\.[^\s<>"]+', str(url))
